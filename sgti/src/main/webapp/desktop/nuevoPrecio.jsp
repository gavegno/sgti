...
<div class="container">
    <div class="row">
        <div class="col-sm-10 col-md-8">
            <h2 class="container text-center">Agregar nuevo precio</h2>
            ...
            <div class="form-group container">
                ...
                <form action="/CounterWebApp/desktop/precio/ingresarPrecioNuevo" method="POST">
                    ...
                    <div class="form-group container">
                        ...
                        <input  type="date" id="fechaDesde" class="form-control" name="fechaDesde" required>
                    </div>
                    

                    <div class="form-group container">
                        <label for="fechaHasta" class="control-label">Fin de vigencia</label>
                        <input  type="date" id="fechaHasta" class="form-control" name="fechaHasta" required>
                    </div>
                    
                    <div class="form-group container">
                        <label for="precio" class="control-label">Valor de precio: </label>
                        <input type="number" step="any" id="precio" class="form-control" name="precio" required>
                    </div> 

                    <div class="form-group container">
                        <label for="precio" class="control-label">Valor de precio de cómputo extra: </label>
                        <input type="number" step="any" id="precioExtra" class="form-control" name="precioExtra" required>
                    </div> 
                ...
                <form class="form-horizontal" action="/CounterWebApp/desktop/precio/tablaPrecios" method="POST">
                    ...
                    <input type="text" name="id" value="${idContrato}" hidden></input>
                        ...
                        <button class="btn btn-default" id="boton" type="submit"> <span class="glyphicon glyphicon-chevron-left"></span> Cancelar y volver </button>
                        <br><br>
                    </div>       
