...
<div class="container">
    <div class="row">
        <div class="col-sm-10 col-md-8">
            <h2 class="container text-center">Ver / editar configuración</h2>
            ...
            <div class="form-group container">
                ...
                <form action="/CounterWebApp/desktop/configuracion/editarConfigOk" method="POST">
                    ...
                    <div class="form-group container">
                        ...
                        <input  type="date" class="form-control" placeholder="Fecha Desde"  name="fechaInicio" value="${config.fechaInicio}" required autofocus>
                    </div>
                    

                    <div class="form-group container">
                        <label for="inputFechaHasta" class="control-label">Fin de vigencia</label>
                        <input  type="date" class="form-control" placeholder="Fecha Hasta"  name="fechaFin" value="${config.fechaFin}"required>
                    </div>
                    ...
                    <div class="form-group container">
                        ...
                        <select class="form-control" name="renovacion" required>
                            <c:choose>
                    ...
                    <div class="form-group container">
                        ...
                        <input type="number" class="form-control" name="computosPaquete" id="computos" value="${config.computosPaquete}" required>
                    </div>
                    ...
                    <div class="form-group container">
                        ...
                        <input type="number" class="form-control" id="inputFrecuenciaFacturacion" name="frecuenciaFacturacion" placeholder="Cantidad" value="${config.frecuenciaFacturacion}" required>
                    </div>
                    ...
                    <div class="form-group container">
                        ...
                        <div class="form-group container">
                            ...
                            <textarea id="inputRespuesta" name="tiempoRespuesta" class="form-control" rows="3">${config.tiempoRespuesta}</textarea>   
                        </div>
                              ...
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel">Eliminar la configuración</h4>
                                  </div>
                                  <div class="modal-body">
                                    ¿Realmente desea eliminar la configuración por completo?
                                  </div>
