...
<div class="container">
    <div class="row">
        <div class="col-sm-10 col-md-8">
            <h2 class="text-center">Gestión de Contrato</h2>
            <div>
                <form class="form-horizontal" action="editarContrato" method="POST">
                    ...
                    <div class="form-group">
                        <label for="inputContraparte" class="control-label">Contraparte:</label>
