...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">SGTI - Itapúa</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Otro menu <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="#">Opcion 1</a></li>
            <li><a href="#">Opcion 2</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="#">Opcion separada</a></li>
          </ul>
        </li>
      </ul>
    </div><!-- /.navbar-collapse -->
